		...
		<c:if test = "${customer != null}">
			...
			<caption>
              ...
              <fieldset class="form-group">
                ...
                <input type="text" pattern = "[0-9]{10}" title = "10 digit phone number" id ="phoneNumber" value="<c:out value='${customer.phoneNumber}' />" class="form-control" name="phoneNumber" required="required">
